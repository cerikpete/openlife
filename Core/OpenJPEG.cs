...
namespace Core
{
    ...
    public class OpenJPEG
    {
        ...
        // encode 
        public static byte[] Encode(Image image, bool lossless)
        {
            if (
        ...
        public static Image Decode(byte[] encoded)
        {
            MarshalledImage marshalled = new MarshalledImage();
            ...
            {
                case 1: // grayscale
                    image = new Image(marshalled.width, marshalled.height, ImageChannels.Color);
                ...
                case 2: // grayscale + alpha
                    image = new Image(marshalled.width, marshalled.height, ImageChannels.Color | ImageChannels.Alpha);
                    Marshal.Copy(marshalled.decoded, image.Red, 0, n);
                    Array.Copy(image.Red, image.Green, n);
                    Array.Copy(image.Red, image.Blue, n);
                ...
                case 5: // RGBBA
                    image = new Image(marshalled.width, marshalled.height, ImageChannels.Color | ImageChannels.Alpha | ImageChannels.Bump);
                    Marshal.Copy(marshalled.decoded, image.Red, 0, n);
                    Marshal.Copy((IntPtr)(marshalled.decoded.ToInt64() + n), image.Green, 0, n);
                    Marshal.Copy((IntPtr)(marshalled.decoded.ToInt64() + n * 2), image.Blue, 0, n);
        ...
        public unsafe static byte[] EncodeFromImage(Bitmap bitmap, bool lossless)
        {
            ...
            {
                // four layers, RGBA
                decoded = new Image(bitmapWidth, bitmapHeight, ImageChannels.Color | ImageChannels.Alpha);
            ...
            {
                // one layer
                decoded = new Image(bitmapWidth, bitmapHeight, ImageChannels.Color);
