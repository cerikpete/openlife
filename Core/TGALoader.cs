...
namespace Core
{
    ...
    public class LoadTGAClass
    {
        ...
        public static unsafe Image LoadTGAImage(System.IO.Stream source)
        {
            return LoadTGAImage(source, false);
        }
        
        public static unsafe Image LoadTGAImage(System.IO.Stream source, bool mask)
        {
            byte[] buffer = new byte[source.Length];
            source.Read(buffer, 0, buffer.Length);
            ...
            {
                image = new Image(header.ImageSpec.Width, header.ImageSpec.Height, ImageChannels.Alpha);
                int p = 3;
            ...
            {
                image = new Image(header.ImageSpec.Width, header.ImageSpec.Height, ImageChannels.Color | ImageChannels.Alpha);
                int p = 0;
